...
function Card(props){
 return(
    <>
   <div classNameName="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
    <div
        ...
        <div className="relative z-10 mx-auto max-w-md">
            ...
            <div className="pt-5 text-base font-semibold leading-7">
                <p>
                    <a href="#" className="text-sky-500 transition-all duration-300 group-hover:text-white">props.btn
                        &rarr;
                    </a>
                </p>
            </div>
